...
# libretro cores
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET 2048"
  #PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET beetle-bsnes"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET beetle-gba"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET beetle-pce-fast"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET bnes"
  #PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET dosbox"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET fceumm"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET gambatte"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET genplus"
  #PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET meteor"
  #PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET mgba"
  #PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET mupen64plus"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET nestopia"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET quicknes"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET stella"
  #PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET vbam"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET vba-next"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET yabause"
